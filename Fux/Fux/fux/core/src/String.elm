...
split sep string =
  Fux.Core.List.fromArray (Fux.Core.String.split sep string)
...
join sep chunks =
  Fux.Core.String.join sep (Fux.Core.List.toArray chunks)
