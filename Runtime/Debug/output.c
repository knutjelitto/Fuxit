...
static void init_func_types(void) {
  ...
  func_types[2] = wasm_rt_register_func_type(2, 1, WASM_RT_F64, WASM_RT_F64, WASM_RT_F64);
}
...
static u32 w2c_square(u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = w2c_p0;
  w2c_i1 = w2c_p0;
...
static f64 w2c___cos(f64 w2c_p0, f64 w2c_p1) {
  FUNC_PROLOGUE;
...
/* export: '__cos' */
f64 (*WASM_RT_ADD_PREFIX(Z___cosZ_ddd))(f64, f64);
/* export: '__dso_handle' */
...
static void init_exports(void) {
  ...
  /* export: '__cos' */
  WASM_RT_ADD_PREFIX(Z___cosZ_ddd) = (&w2c___cos);
  /* export: '__dso_handle' */
